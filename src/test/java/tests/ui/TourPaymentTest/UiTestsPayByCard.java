package tests.ui.TourPaymentTest;
...
public class UiTestsPayByCard {
    ...
    public void paymentForTourByCardStatusDeclined() {
        CardInfo declinedCard = generateInValidCardInfo();
    ...
    @Test
    @DisplayName("Валидация данных в поле “Месяц”: значение 01")
    public void validationFieldMonth00Value() {
        CardInfo invalidMonth = new CardInfo("", "01", "", "", "");
